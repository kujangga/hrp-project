...
export default function EditVideographerPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/admin/videographers');
            router.refresh();
        } catch {
            setError('Failed to update videographer. Please try again.');
        } finally {
            setIsSaving(false);
        }
    };
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            setError('Failed to delete videographer. Please try again.');
        ...
        return (
            <div className="max-w-4xl mx-auto">
                <div className="p-8 text-center">
                    ...
                    <h2 className="text-xl font-semibold text-white mb-2">Videographer Not Found</h2>
                    <p className="text-gray-400 mb-6">The videographer you&apos;re looking for doesn&apos;t exist.</p>
                    <Link
        ...
        <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
                    <div className="bg-[#1a1a24] border border-white/10 rounded-2xl p-6 max-w-md mx-4">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-white">Delete Videographer</h3>
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl lg:text-3xl font-bold text-white">Edit Videographer</h1>
                        <p className="text-gray-400 mt-1">Update videographer details</p>
                    </div>
                </div>
                <button
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 p-6">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-pink-500/20 to-rose-500/20 flex items-center justify-center border-2 border-dashed border-white/20 overflow-hidden">
