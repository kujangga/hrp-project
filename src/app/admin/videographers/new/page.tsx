...
export default function NewVideographerPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('/api/admin/videographers', {
                method: 'POST',
            ...
            if (!response.ok) {
                throw new Error('Failed to create videographer');
            }

            router.push('/admin/videographers');
            router.refresh();
        } catch {
            setError('Failed to create videographer. Please try again.');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl lg:text-3xl font-bold text-white">Add New Videographer</h1>
                    <p className="text-gray-400 mt-1">Create a new videographer profile</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 p-6">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-pink-500/20 to-rose-500/20 flex items-center justify-center border-2 border-dashed border-white/20">
                ...
                <div className="rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            rows={4}
                            placeholder="Brief description about the videographer's experience and style..."
